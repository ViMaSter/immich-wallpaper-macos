...
- To remove: `launchctl unload ~/Library/LaunchAgents/com.vimaster.wallpaper.rotate.plist && launchctl unload ~/Library/LaunchAgents/com.vimaster.wallpaper.onwake.plist` and delete the files.
